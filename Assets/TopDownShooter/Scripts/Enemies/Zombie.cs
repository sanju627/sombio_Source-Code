...
public class Zombie : MonoBehaviour
{
    ...
    void SearchWalkPoint()
    {
        ...
        {
            Transform tSpawn = wanderPoint[Random.Range(0, wanderPoint.Length)];
            walkPoint = new Vector3(tSpawn.position.x, transform.position.y, tSpawn.position.z);
        }
    ...
    public void Foots()
    {
        footAud.PlayOneShot(footStepSFX[Random.Range(0, footStepSFX.Length)]);
    }
    ...
    public void Attack()
    {
        ...
        audio.PlayOneShot(growlingSFX[Random.Range(0, growlingSFX.Length)]);
